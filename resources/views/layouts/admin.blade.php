        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto mt-5 scrollbar-hide">
                <div class="px-4 space-y-2">
                    <!-- Dashboard -->
                    <a href="/" class="flex items-center px-4 py-3 text-[#DEE4EE] hover:bg-[#333A48] rounded-md transition-all duration-300 group">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 pull-right rounded-br-md rounded-bl-md h-5/6" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                        <span :class="!sidebarOpen && 'hidden lg:hidden'">Dashboard</span>
                    </a>

                    <!-- Products -->
                    <a href="/products" class="flex items-center px-4 py-3 text-[#DEE4EE] hover:bg-[#333A48] rounded-md transition-all duration-300 group">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Rent -->
                    <a href="/rent" class="flex items-center px-4 py-3 text-[#DEE4EE] hover:bg-[#333A48] rounded-md transition-all duration-300 group">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span :class="!sidebarOpen && 'hidden lg:hidden'">Rent</span>
                    </a>

                    <!-- Delivery -->
                    <a href="/deliveries" class="flex items-center px-4 py-3 text-[#DEE4EE] hover:bg-[#333A48] rounded-md transition-all duration-300 group">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                        </svg>
                        <span :class="!sidebarOpen && 'hidden lg:hidden'">Delivery</span>
                    </a>

                    <!-- Return -->
                    <a href="/returns" class="flex items-center px-4 py-3 text-[#DEE4EE] hover:bg-[#333A48] rounded-md transition-all duration-300 group">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span :class="!sidebarOpen && 'hidden lg:hidden'">Return</span>
                    </a>
                    ...
                    <a href="#" class="flex items-center px-4 py-3 text-[#DEE4EE] hover:bg-[#333A48] rounded-md transition-all duration-300 group">
                        ...
                        <span :class="!sidebarOpen && 'hidden lg:hidden'">Invoices</span>
                    </a>
                </div>
            </nav>
        </aside>
